...
hotcitys[0]=new Array('bj','北京','beijing','bj','21523','beijing','北京','','',12,0);

hotcitys[1]=new Array('sh','上海','shanghai','sh','16004','shanghai','上海','','',13,0);

hotcitys[3]=new Array('gz','广州','guangzhou','gz','11507','guangdong','广东','','',16,0);

hotcitys[2]=new Array('cd','成都','chengdu','cd','17830','sichuan','四川','','',45,0);

hotcitys[4]=new Array('sz','深圳','shenzhen','sz','7381','guangdong','广东','','',17,0);

hotcitys[8]=new Array('xa','西安','xian','xa','13021','shanxi','陕西','','',176,0);

hotcitys[15]=new Array('nj','南京','nanjing','nj','6160','jiangsu','江苏','','',65,0);

hotcitys[9]=new Array('hz','杭州','hangzhou','hz','8129','zhejiang','浙江','','',26,0);

hotcitys[7]=new Array('cq','重庆','chongqing','cq','14545','chongqing','重庆','','',15,0);

hotcitys[12]=new Array('wh','武汉','wuhan','wh','9267','hubei','湖北','','',194,0);

hotcitys[16]=new Array('sz','苏州','suzhou','su','5613','jiangsu','江苏','','',67,0);

hotcitys[18]=new Array('qd','青岛','qingdao','qd','10977','shandong','山东','','',114,0);

hotcitys[11]=new Array('xm','厦门','xiamen','xm','6363','fujian','福建','','',76,0);

hotcitys[6]=new Array('sy','三亚','sanya','sanya','7110','hainan','海南','','',144,0);

hotcitys[10]=new Array('heb','哈尔滨','haerbin','hrb','3965','heilongjiang','黑龙江','','',93,0);

hotcitys[14]=new Array('tj','天津','tianjin','tj','3068','tianjin','天津','','',14,0);

hotcitys[17]=new Array('km','昆明','kunming','km','3816','yunnan','云南','','',225,0);

hotcitys[5]=new Array('xg','香港','xianggang','hongkong','2740','xianggang','香港','','',344,0);

hotcitys[13]=new Array('cs','长沙','changsha','cs','5063','hunan','湖南','','',204,0);
...
citys[0]=new Array('bj','北京','beijing','bj','21523','beijing','北京','','',12,0);

citys[1]=new Array('sh','上海','shanghai','sh','16004','shanghai','上海','','',13,0);

citys[2]=new Array('gz','广州','guangzhou','gz','11507','guangdong','广东','','',16,0);

citys[3]=new Array('cd','成都','chengdu','cd','17830','sichuan','四川','','',45,0);

citys[4]=new Array('sz','深圳','shenzhen','sz','7381','guangdong','广东','','',17,0);

citys[5]=new Array('xa','西安','xian','xa','13021','shanxi','陕西','','',176,0);

citys[6]=new Array('nj','南京','nanjing','nj','6160','jiangsu','江苏','','',65,0);

citys[7]=new Array('hz','杭州','hangzhou','hz','8129','zhejiang','浙江','','',26,0);

citys[8]=new Array('cq','重庆','chongqing','cq','14545','chongqing','重庆','','',15,0);

citys[9]=new Array('wh','武汉','wuhan','wh','9267','hubei','湖北','','',194,0);

citys[10]=new Array('sz','苏州','suzhou','su','5613','jiangsu','江苏','','',67,0);

citys[11]=new Array('wx','无锡','wuxi','wx','1624','jiangsu','江苏','','',66,0);

citys[12]=new Array('qd','青岛','qingdao','qd','10977','shandong','山东','','',114,0);

citys[13]=new Array('xm','厦门','xiamen','xm','6363','fujian','福建','','',76,0);

citys[14]=new Array('sy','三亚','sanya','sanya','7110','hainan','海南','','',144,0);

citys[15]=new Array('dl','大连','dalian','dl','4288','liaoning','辽宁','','',56,0);

citys[16]=new Array('heb','哈尔滨','haerbin','hrb','3965','heilongjiang','黑龙江','','',93,0);

citys[17]=new Array('qhd','秦皇岛','qinhuangdao','qinhuangdao','5606','hebei','河北','','',3,0);

citys[18]=new Array('tj','天津','tianjin','tj','3068','tianjin','天津','','',14,0);

citys[19]=new Array('km','昆明','kunming','km','3816','yunnan','云南','','',225,0);

citys[20]=new Array('xg','香港','xianggang','hongkong','2740','xianggang','香港','','',344,0);

citys[21]=new Array('cc','长春','changchun','cc','1245','jilin','吉林','','',84,0);

citys[22]=new Array('sy','沈阳','shenyang','sy','2483','liaoning','辽宁','','',55,0);

citys[23]=new Array('hf','合肥','hefei','hf','1566','anhui','安徽','','',123,0);

citys[24]=new Array('zz','郑州','zhengzhou','zz','2078','henan','河南','','',103,0);

citys[25]=new Array('ty','太原','taiyuan','ty','1572','shanxi','山西','','',155,0);

citys[26]=new Array('wh','威海','weihai','wei','3493','shandong','山东','','',120,0);

citys[27]=new Array('lj','丽江','lijiang','lijiang','2950','yunnan','云南','','',230,0);

citys[28]=new Array('dl','大理','dali','dali','3521','yunnan','云南','','',237,0);

citys[29]=new Array('gl','桂林','guilin','gl','2003','guangxi','广西','','',134,0);

citys[30]=new Array('am','澳门','aomen','macao','618','aomen','澳门','','',345,0);

citys[31]=new Array('fz','福州','fuzhou','fz','1646','fujian','福建','','',75,0);

citys[32]=new Array('nb','宁波','ningbo','nb','1911','zhejiang','浙江','','',27,0);

citys[33]=new Array('zh','珠海','zhuhai','zhuhai','1848','guangdong','广东','','',18,0);

citys[34]=new Array('cs','长沙','changsha','cs','5063','hunan','湖南','','',204,0);

citys[35]=new Array('sjz','石家庄','shijiazhuang','sjz','1253','hebei','河北','','',1,0);

citys[36]=new Array('ls','拉萨','lasa','ls','275','xicang','西藏','','',256,0);

citys[37]=new Array('cz','常州','changzhou','changzhou','723','jiangsu','江苏','','',69,0);

citys[38]=new Array('yz','扬州','yangzhou','yangzhou','1326','jiangsu','江苏','','',74,0);

citys[39]=new Array('dg','东莞','dongguan','dg','452','guangdong','广东','','',24,0);

citys[40]=new Array('hk','海口','haikou','hn','2101','hainan','海南','','',143,0);

citys[41]=new Array('lz','兰州','lanzhou','lz','1196','gansu','甘肃','','',166,0);

citys[42]=new Array('ly','洛阳','luoyang','luoyang','1190','henan','河南','','',104,0);

citys[43]=new Array('wlmq','乌鲁木齐','wulumuqi','xj','140','xinjiang','新疆','','',241,0);

citys[44]=new Array('xz','徐州','xuzhou','xuzhou','577','jiangsu','江苏','','',68,0);

citys[45]=new Array('gy','贵阳','guiyang','gy','2009','guizhou','贵州','','',36,0);

citys[46]=new Array('hhht','呼和浩特','huhehaote','nmg','562','neimenggu','内蒙古','','',145,0);

citys[47]=new Array('jn','济南','jinan','jn','1468','shandong','山东','','',113,0);

citys[48]=new Array('ts','唐山','tangshan','tangshan','736','hebei','河北','','',2,0);

citys[49]=new Array('bd','保定','baoding','baoding','637','hebei','河北','','',6,0);

citys[50]=new Array('nc','南昌','nanchang','nc','1114','jiangxi','江西','','',214,0);

citys[51]=new Array('hd','邯郸','handan','handan','185','hebei','河北','','',4,0);

citys[52]=new Array('nn','南宁','nanning','nn','1423','guangxi','广西','','',142,0);

citys[53]=new Array('wf','潍坊','weifang','weifang','394','shandong','山东','','',119,0);

citys[54]=new Array('jz','锦州','jinzhou','jinzhou','316','liaoning','辽宁','','',60,0);

citys[55]=new Array('rz','日照','rizhao','rizhao','1744','shandong','山东','','',306,0);

citys[56]=new Array('ly','临沂','linyi','linyi','194','shandong','山东','','',307,0);

citys[57]=new Array('as','鞍山','anshan','anshan','85','liaoning','辽宁','','',57,0);

citys[58]=new Array('lf','廊坊','langfang','langfang','825','hebei','河北','','',10,0);

citys[59]=new Array('dq','大庆','daqing','daqing','161','heilongjiang','黑龙江','','',98,0);

citys[60]=new Array('bh','北海','beihai','beihai','2830','guangxi','广西','','',317,0);

citys[61]=new Array('zs','中山','zhongshan','zhongshan','331','guangdong','广东','','',25,0);

citys[62]=new Array('xn','西宁','xining','xn','1161','qinghai','青海','','',186,0);

citys[63]=new Array('jh','金华','jinhua','jinhua','601','zhejiang','浙江','','',32,0);

citys[64]=new Array('dd','丹东','dandong','dandong','693','liaoning','辽宁','','',59,0);

citys[65]=new Array('cd','承德','chengde','chengde','2066','hebei','河北','','',8,0);

citys[66]=new Array('pj','盘锦','panjin','panjin','183','liaoning','辽宁','','',63,0);

citys[67]=new Array('zb','淄博','zibo','zibo','250','shandong','山东','','',115,0);

citys[68]=new Array('zz','株洲','zhuzhou','zhuzhou','152','hunan','湖南','','',205,0);

citys[69]=new Array('fs','佛山','foshan','foshan','965','guangdong','广东','','',20,0);

citys[70]=new Array('jl','吉林','jilinshi','jilin','298','jilin','吉林','','',85,0);

citys[71]=new Array('yl','玉林','yulin','gxyulin','20','guangxi','广西','','',138,0);

citys[72]=new Array('xt','邢台','xingtai','xingtai','95','hebei','河北','','',5,0);

citys[73]=new Array('qqhe','齐齐哈尔','qiqihaer','qiqihaer','105','heilongjiang','黑龙江','','',94,0);

citys[74]=new Array('yc','宜昌','yichang','yichang','604','hubei','湖北','','',199,0);

citys[75]=new Array('dt','大同','datong','datong','460','shanxi','山西','','',156,0);

citys[76]=new Array('yt','烟台','yantai','yantai','3489','shandong','山东','','',118,0);

citys[77]=new Array('yc','银川','yinchuan','yc','249','ningxia','宁夏','','',165,0);

citys[78]=new Array('wz','温州','wenzhou','wenzhou','953','zhejiang','浙江','','',28,0);

citys[79]=new Array('ha','淮安','huaian','huaian','72','jiangsu','江苏','','',72,0);

citys[80]=new Array('my','绵阳','mianyang','mianyang','420','sichuan','四川','','',49,0);

citys[81]=new Array('bt','包头','baotou','baotou','235','neimenggu','内蒙古','','',146,0);

citys[82]=new Array('fs','抚顺','fushun','fushun','79','liaoning','辽宁','','',58,0);

citys[83]=new Array('ta','泰安','taian','taian','590','shandong','山东','','',305,0);

citys[84]=new Array('jn','济宁','jining','jining','249','shandong','山东','','',304,0);

citys[85]=new Array('lyg','连云港','lianyungang','lianyungang','328','jiangsu','江苏','','',71,0);

citys[86]=new Array('hnz','海南州','hainan','hainanzhou','10','qinghai','青海','','',190,0);

citys[87]=new Array('qz','泉州','quanzhou','quanzhou','785','fujian','福建','','',79,0);

citys[88]=new Array('ay','安阳','anyang','anyang','86','henan','河南','','',109,0);

citys[89]=new Array('hz','惠州','huizhou','huizhou','4700','guangdong','广东','','',23,0);

citys[90]=new Array('hld','葫芦岛','huludao','huludao','2656','liaoning','辽宁','','',64,0);

citys[91]=new Array('jx','嘉兴','jiaxing','jiaxing','1691','zhejiang','浙江','','',29,0);

citys[92]=new Array('nt','南通','nantong','nantong','531','jiangsu','江苏','','',70,0);

citys[93]=new Array('pzh','攀枝花','panzhihua','panzhihua','113','sichuan','四川','','',274,0);

citys[94]=new Array('lz','柳州','liuzhou','liuzhou','218','guangxi','广西','','',133,0);

citys[95]=new Array('dy','东营','dongying','dongying','35','shandong','山东','','',117,0);

citys[96]=new Array('jms','佳木斯','jiamusi','jiamusi','120','heilongjiang','黑龙江','','',100,0);

citys[97]=new Array('tl','通辽','tongliao','tongliao','43','neimenggu','内蒙古','','',149,0);

citys[98]=new Array('dz','德州','dezhou','dezhou','194','shandong','山东','','',308,0);

citys[99]=new Array('gz','赣州','ganzhou','ganzhou','130','jiangxi','江西','','',220,0);

citys[100]=new Array('bz','滨州','binzhou','binzhou','46','shandong','山东','','',122,0);

citys[101]=new Array('xy','咸阳','xianyang','xianyang','261','shanxi','陕西','','',179,0);

citys[102]=new Array('jm','江门','jiangmen','jiangmen','195','guangdong','广东','','',21,0);

citys[103]=new Array('zz','漳州','zhangzhou','zhangzhou','1119','fujian','福建','','',80,0);

citys[104]=new Array('xx','新乡','xinxiang','xinxiang','231','henan','河南','','',108,0);

citys[105]=new Array('xy','襄阳','xiangyang','xiangyang','135','hubei','湖北','','',196,0);

citys[106]=new Array('nc','南充','nanchong','nanchong','246','sichuan','四川','','',51,0);

citys[107]=new Array('lc','聊城','liaocheng','liaocheng','116','shandong','山东','','',309,0);

citys[108]=new Array('zjk','张家口','zhangjiakou','zhangjiakou','966','hebei','河北','','',7,0);

citys[109]=new Array('cz','沧州','cangzhou','cangzhou','112','hebei','河北','','',9,0);

citys[110]=new Array('shz','石河子','shihezi','shihezi','21','xinjiang','新疆','','',255,0);

citys[111]=new Array('bj','宝鸡','baoji','baoji','70','shanxi','陕西','','',178,0);

citys[112]=new Array('cf','赤峰','chifeng','chifeng','135','neimenggu','内蒙古','','',148,0);

citys[113]=new Array('zj','湛江','zhanjiang','zhanjiang','347','guangdong','广东','','',264,0);

citys[114]=new Array('sq','商丘','shangqiu','shangqiu','68','henan','河南','','',297,0);

citys[115]=new Array('pds','平顶山','pingdingshan','pingdingshan','40','henan','河南','','',105,0);

citys[116]=new Array('xy','信阳','xinyang','xinyang','63','henan','河南','','',298,0);

citys[117]=new Array('jj','九江','jiujiang','jiujiang','308','jiangxi','江西','','',217,0);

citys[118]=new Array('yk','营口','yingkou','yingkou','2232','liaoning','辽宁','','',61,0);

citys[119]=new Array('bx','本溪','benxi','benxi','156','liaoning','辽宁','','',286,0);

citys[120]=new Array('ly','辽阳','liaoyang','liaoyang','3','liaoning','辽宁','','',62,0);

citys[121]=new Array('qz','钦州','qinzhou','qinzhou','18','guangxi','广西','','',136,0);

citys[122]=new Array('hy','衡阳','hengyang','hengyang','174','hunan','湖南','','',207,0);

citys[123]=new Array('st','汕头','shantou','shantou','618','guangdong','广东','','',19,0);

citys[124]=new Array('wh','芜湖','wuhu','wuhu','157','anhui','安徽','','',124,0);

citys[125]=new Array('hlbe','呼伦贝尔','hulunbeier','hulunbeier','462','neimenggu','内蒙古','','',151,0);

citys[126]=new Array('xt','湘潭','xiangtan','xiangtan','74','hunan','湖南','','',206,0);

citys[127]=new Array('cys','朝阳市','chaoyang','chaoyang','24','liaoning','辽宁','','',289,0);

citys[128]=new Array('qy','清远','qingyuan','qingyuan','967','guangdong','广东','','',270,0);

citys[129]=new Array('sn','遂宁','suining','suining','32','sichuan','四川','','',276,0);

citys[130]=new Array('tz','泰州','taizhoujs','jstaizhou','79','jiangsu','江苏','','',291,0);

citys[131]=new Array('pt','莆田','putian','putian','55','fujian','福建','','',77,0);

citys[132]=new Array('zz','枣庄','zaozhuang','zaozhuang','420','shandong','山东','','',116,0);

citys[133]=new Array('lz','泸州','luzhou','luzhou','139','sichuan','四川','','',47,0);

citys[134]=new Array('zs','舟山','zhoushan','zhoushan','1733','zhejiang','浙江','','',34,0);

citys[135]=new Array('zj','镇江','zhenjiang','zhenjiang','215','jiangsu','江苏','','',290,0);

citys[136]=new Array('kf','开封','kaifeng','kaifeng','611','henan','河南','','',293,0);

citys[137]=new Array('eeds','鄂尔多斯','eerduosi','eerduosi','73','neimenggu','内蒙古','','',150,0);

citys[138]=new Array('sy','十堰','shiyan','shiyan','93','hubei','湖北','','',197,0);

citys[139]=new Array('yb','延边','yanbian','yanbian','334','jilin','吉林','','',92,0);

citys[140]=new Array('hb','淮北','huaibei','huaibei','31','anhui','安徽','','',311,0);

citys[141]=new Array('lf','临汾','linfen','linfen','134','shanxi','山西','','',164,0);

citys[142]=new Array('cd','常德','changde','changde','87','hunan','湖南','','',210,0);

citys[143]=new Array('jz','荆州','jingzhou','jingzhou','91','hubei','湖北','','',198,0);

citys[144]=new Array('cz','郴州','chenzhou','chenzhou','384','hunan','湖南','','',211,0);

citys[145]=new Array('dy','德阳','deyang','deyang','149','sichuan','四川','','',48,0);

citys[146]=new Array('sx','绍兴','shaoxing','shaoxing','376','zhejiang','浙江','','',31,0);

citys[147]=new Array('ny','南阳','nanyang','nanyang','111','henan','河南','','',111,0);

citys[148]=new Array('hz','菏泽','heze','heze','60','shandong','山东','','',338,0);

citys[149]=new Array('tz','台州','taizhouzj','taizhouzj','577','zhejiang','浙江','','',35,0);

citys[150]=new Array('zy','遵义','zunyi','zunyi','148','guizhou','贵州','','',38,0);

citys[151]=new Array('fx','阜新','fuxin','fuxin','12','liaoning','辽宁','','',287,0);

citys[152]=new Array('yc','盐城','yancheng','yancheng','76','jiangsu','江苏','','',73,0);

citys[153]=new Array('xq','宿迁','suqian','suqian','31','jiangsu','江苏','','',292,0);

citys[154]=new Array('jz','焦作','jiaozuo','jiaozuo','59','henan','河南','','',106,0);

citys[155]=new Array('cz','长治','changzhi','changzhi','91','shanxi','山西','','',158,0);

citys[156]=new Array('ja','吉安','jian','jian','94','jiangxi','江西','','',221,0);

citys[157]=new Array('dz','达州','dazhou','dazhou','29','sichuan','四川','','',53,0);

citys[158]=new Array('lh','漯河','luohe','luohe','11','henan','河南','','',110,0);

citys[159]=new Array('zmd','驻马店','zhumadian','zhumadian','32','henan','河南','','',300,0);

citys[160]=new Array('hz','汉中','hanzhong','hanzhong','94','shanxi','陕西','','',182,0);

citys[161]=new Array('hy','河源','heyuan','heyuan','103','guangdong','广东','','',268,0);

citys[162]=new Array('tl','铁岭','tieling','tieling','26','liaoning','辽宁','','',288,0);

citys[163]=new Array('jz','晋中','jinzhong','jinzhong','900','shanxi','山西','','',161,0);

citys[164]=new Array('ak','安康','ankang','ankang','27','shanxi','陕西','','',184,0);

citys[165]=new Array('xg','孝感','xiaogan','xiaogan','13','hubei','湖北','','',327,0);

citys[166]=new Array('yy','岳阳','yueyang','yueyang','111','hunan','湖南','','',209,0);

citys[167]=new Array('zq','肇庆','zhaoqing','zhaoqing','188','guangdong','广东','','',265,0);

citys[168]=new Array('hs','衡水','hengshui','hengshui','372','hebei','河北','','',11,0);

citys[169]=new Array('mdj','牡丹江','mudanjiang','mudanjiang','149','heilongjiang','黑龙江','','',302,0);

citys[170]=new Array('aq','安庆','anqing','anqing','29','anhui','安徽','','',127,0);

citys[171]=new Array('hg','黄冈','huanggang','huanggang','29','hubei','湖北','','',328,0);

citys[172]=new Array('ld','娄底','loudi','loudi','32','hunan','湖南','','',213,0);

citys[173]=new Array('ls','乐山','leshan','leshan','1403','sichuan','四川','','',50,0);

citys[174]=new Array('sp','四平','siping','siping','51','jilin','吉林','','',86,0);

citys[175]=new Array('bb','蚌埠','bengbu','bengbu','85','anhui','安徽','','',125,0);

citys[176]=new Array('sg','韶关','shaoguan','shaoguan','169','guangdong','广东','','',263,0);

citys[177]=new Array('yj','阳江','yangjiang','yangjiang','917','guangdong','广东','','',269,0);

citys[178]=new Array('cz','潮州','chaozhou','chaozhou','260','guangdong','广东','','',271,0);

citys[179]=new Array('zjj','张家界','zhangjiajie','zhangjiajie','860','hunan','湖南','','',334,0);

citys[180]=new Array('hh','怀化','huaihua','huaihua','42','hunan','湖南','','',336,0);

citys[181]=new Array('xsbn','西双版纳','xishuangbanna','xishuangbanna','1334','yunnan','云南','','',235,0);

citys[182]=new Array('sm','三明','sanming','sanming','49','fujian','福建','','',78,0);

citys[183]=new Array('hn','淮南','huainan','huainan','48','anhui','安徽','','',310,0);

citys[184]=new Array('yc','运城','yuncheng','yuncheng','100','shanxi','山西','','',162,0);

citys[185]=new Array('ms','眉山','meishan','meishan','147','sichuan','四川','','',279,0);

citys[186]=new Array('xc','许昌','xuchang','xuchang','44','henan','河南','','',295,0);

citys[187]=new Array('sh','绥化','suihua','suihua','24','heilongjiang','黑龙江','','',102,0);

citys[188]=new Array('fcg','防城港','fangchenggang','fangchenggang','367','guangxi','广西','','',318,0);

citys[189]=new Array('yz','永州','yongzhou','yongzhou','19','hunan','湖南','','',212,0);

citys[190]=new Array('yy','益阳','yiyang','yiyang','18','hunan','湖南','','',335,0);

citys[191]=new Array('sr','上饶','shangrao','shangrao','404','jiangxi','江西','','',224,0);

citys[192]=new Array('qz','衢州','quzhou','quzhou','91','zhejiang','浙江','','',33,0);

citys[193]=new Array('lps','六盘水','liupanshui','liupanshui','210','guizhou','贵州','','',37,0);

citys[194]=new Array('zk','周口','zhoukou','zhoukou','12','henan','河南','','',299,0);

citys[195]=new Array('bs','白山','baishan','baishan','199','jilin','吉林','','',89,0);

citys[196]=new Array('la','六安','luan','luan','10','anhui','安徽','','',132,0);

citys[197]=new Array('tl','铜陵','tongling','tongling','29','anhui','安徽','','',312,0);

citys[198]=new Array('sz','池州','chizhou','chizhou','135','anhui','安徽','','',315,0);

citys[199]=new Array('jc','晋城','jincheng','jincheng','76','shanxi','山西','','',159,0);

citys[200]=new Array('hs','黄石','huangshi','huangshi','29','hubei','湖北','','',195,0);

citys[201]=new Array('xx','湘西','xiangxi','xiangxi','304','hunan','湖南','','',337,0);

citys[202]=new Array('yc','宜春','yichunjx','jxyichun','115','jiangxi','江西','','',222,0);

citys[203]=new Array('mm','茂名','maoming','maoming','51','guangdong','广东','','',22,0);

citys[204]=new Array('mz','梅州','meizhou','meizhou','64','guangdong','广东','','',266,0);

citys[205]=new Array('ls','凉山','liangshan','liangshan','708','sichuan','四川','','',54,0);

citys[206]=new Array('yb','宜宾','yibin','yibin','93','sichuan','四川','','',52,0);

citys[207]=new Array('hz','湖州','huzhou','huzhou','1769','zhejiang','浙江','','',30,0);

citys[208]=new Array('py','濮阳','puyang','puyang','12','henan','河南','','',294,0);

citys[209]=new Array('cz','滁州','chuzhou','chuzhou','61','anhui','安徽','','',128,0);

citys[210]=new Array('ch','巢湖','chaohu','chaohu','8','anhui','安徽','','',131,0);

citys[211]=new Array('hle','海拉尔','hailaer','hailaer','16','neimenggu','内蒙古','','',367,0);

citys[212]=new Array('ya','延安','yanan','yanan','177','shanxi','陕西','','',181,0);

citys[213]=new Array('nj','内江','neijiang','neijiang','71','sichuan','四川','','',277,0);

citys[214]=new Array('np','南平','nanping','nanping','60','fujian','福建','','',81,0);

citys[215]=new Array('smx','三门峡','sanmenxia','sanmenxia','11','henan','河南','','',296,0);

citys[216]=new Array('ly','辽源','liaoyuan','liaoyuan','11','jilin','吉林','','',87,0);

citys[217]=new Array('sy','松原','songyuan','songyuan','56','jilin','吉林','','',90,0);

citys[218]=new Array('sys','双鸭山','shuangyashan','shuangyashan','2','heilongjiang','黑龙江','','',97,0);

citys[219]=new Array('fy','阜阳','fuyang','fuyang','25','anhui','安徽','','',129,0);

citys[220]=new Array('hs','黄山','huangshan','huangshan','1104','anhui','安徽','','',313,0);

citys[221]=new Array('byne','巴彦淖尔','bayannaoer','bayannaoer','5','neimenggu','内蒙古','','',152,0);

citys[222]=new Array('wn','渭南','weinan','weinan','139','shanxi','陕西','','',180,0);

citys[223]=new Array('xn','咸宁','xianning','xianning','44','hubei','湖北','','',329,0);

citys[224]=new Array('es','恩施','enshi','enshi','1015','hubei','湖北','','',331,0);
...
citys[227]=new Array('ly','龙岩','longyan','longyan','88','fujian','福建','','',82,0);

citys[228]=new Array('th','通化','tonghua','tonghua','153','jilin','吉林','','',88,0);

citys[229]=new Array('bc','白城','baicheng','baicheng','21','jilin','吉林','','',91,0);

citys[230]=new Array('lw','莱芜','laiwu','laiwu','12','shandong','山东','','',121,0);

citys[231]=new Array('xc','宣城','xuancheng','xuancheng','106','anhui','安徽','','',316,0);

citys[232]=new Array('xlgl','锡林郭勒','xilinguole','xilinguole','127','neimenggu','内蒙古','','',321,0);

citys[233]=new Array('sy','邵阳','shaoyang','shaoyang','25','hunan','湖南','','',208,0);

citys[234]=new Array('jdz','景德镇','jingdezhen','jingdezhen','274','jiangxi','江西','','',215,0);

citys[235]=new Array('qj','曲靖','qujing','qujing','52','yunnan','云南','','',226,0);

citys[236]=new Array('jy','揭阳','jieyang','jieyang','15','guangdong','广东','','',272,0);

citys[237]=new Array('gy','广元','guangyuan','guangyuan','105','sichuan','四川','','',275,0);

citys[238]=new Array('bz','巴中','bazhong','bazhong','2','sichuan','四川','','',281,0);

citys[239]=new Array('jy','济源','jiyuan','jiyuan','15','henan','河南','','',112,0);

citys[240]=new Array('hg','鹤岗','hegang','hegang','6','heilongjiang','黑龙江','','',96,0);

citys[241]=new Array('hh','黑河','heihe','heihe','89','heilongjiang','黑龙江','','',101,0);

citys[242]=new Array('ll','吕梁','lvliang','lvliang','27','shanxi','山西','','',323,0);

citys[243]=new Array('ts','天水','tianshui','tianshui','70','gansu','甘肃','','',169,0);

citys[244]=new Array('yl','榆林','sxyulin','sxyulin','14','shanxi','陕西','','',183,0);

citys[245]=new Array('px','萍乡','pingxiang','pingxiang','58','jiangxi','江西','','',216,0);

citys[246]=new Array('hm','哈密','hami','hami','10','xinjiang','新疆','','',244,0);

citys[247]=new Array('yf','云浮','yunfu','yunfu','5','guangdong','广东','','',273,0);

citys[248]=new Array('zg','自贡','zigong','zigong','120','sichuan','四川','','',46,0);

citys[249]=new Array('ab','阿坝','aba','aba','90','sichuan','四川','','',283,0);

citys[250]=new Array('nd','宁德','ningde','ningde','236','fujian','福建','','',83,0);

citys[251]=new Array('mas','马鞍山','maanshan','maanshan','7','anhui','安徽','','',126,0);

citys[252]=new Array('als','阿拉善','alashan','alashan','169','neimenggu','内蒙古','','',322,0);

citys[253]=new Array('yq','阳泉','yangquan','yangquan','22','shanxi','山西','','',157,0);

citys[254]=new Array('xy','新余','xinyu','xinyu','9','jiangxi','江西','','',218,0);

citys[255]=new Array('ks','喀什','kashi','kashi','5','xinjiang','新疆','','',247,0);

citys[256]=new Array('bj','毕节','bijie','bijie','14','guizhou','贵州','','',41,0);

citys[257]=new Array('qxn','黔西南','qianxinan','qianxinan','159','guizhou','贵州','','',42,0);

citys[258]=new Array('jx','鸡西','jixi','jixi','41','heilongjiang','黑龙江','','',95,0);

citys[259]=new Array('yc','伊春','hljyichun','hljyichun','149','heilongjiang','黑龙江','','',99,0);

citys[260]=new Array('dxal','大兴安岭','daxinganling','daxinganling','23','heilongjiang','黑龙江','','',303,0);

citys[261]=new Array('xz','宿州','suzhouah','ahsuzhou','38','anhui','安徽','','',130,0);

citys[262]=new Array('wz','梧州','wuzhou','wuzhou','52','guangxi','广西','','',135,0);

citys[263]=new Array('gg','贵港','guigang','guigang','5','guangxi','广西','','',137,0);

citys[264]=new Array('sz','朔州','shuozhou','shuozhou','8','shanxi','山西','','',160,0);

citys[265]=new Array('qy','庆阳','qingyang','qingyang','7','gansu','甘肃','','',174,0);

citys[266]=new Array('ez','鄂州','ezhou','ezhou','32','hubei','湖北','','',201,0);

citys[267]=new Array('aks','阿克苏','akesu','akesu','11','xinjiang','新疆','','',246,0);

citys[268]=new Array('sw','汕尾','shanwei','shanwei','105','guangdong','广东','','',267,0);

citys[269]=new Array('ga','广安','guangan','guangan','29','sichuan','四川','','',278,0);

citys[270]=new Array('zy','资阳','ziyang','ziyang','40','sichuan','四川','','',282,0);

citys[271]=new Array('as','安顺','anshun','anshun','113','guizhou','贵州','','',39,0);

citys[272]=new Array('qdn','黔东南','qiandongnan','qiandongnan','480','guizhou','贵州','','',43,0);

citys[273]=new Array('dz','定州','dingzhou','dingzhou','8','hebei','河北','','',354,0);

citys[274]=new Array('qth','七台河','qitaihe','qitaihe','1','heilongjiang','黑龙江','','',301,0);

citys[275]=new Array('hs','河池','hechi','hechi','34','guangxi','广西','','',140,0);

citys[276]=new Array('wh','乌海','wuhai','wuhai','12','neimenggu','内蒙古','','',147,0);

citys[277]=new Array('zy','张掖','zhangye','zhangye','144','gansu','甘肃','','',171,0);

citys[278]=new Array('jq','酒泉','jiuquan','jiuquan','415','gansu','甘肃','','',173,0);

citys[279]=new Array('ln','陇南','longnan','longnan','9','gansu','甘肃','','',324,0);

citys[280]=new Array('snj','神农架','shennongjia','shennongjia','75','hubei','湖北','','',333,0);

citys[281]=new Array('klmy','克拉玛依','kelamayi','kelamayi','3','xinjiang','新疆','','',242,0);

citys[282]=new Array('yl','伊犁','yili','yili','93','xinjiang','新疆','','',252,0);

citys[283]=new Array('alt','阿勒泰','aletai','aletai','18','xinjiang','新疆','','',254,0);

citys[284]=new Array('ya','雅安','yaan','yaan','128','sichuan','四川','','',280,0);

citys[285]=new Array('gz','甘孜','ganzi','ganzi','521','sichuan','四川','','',284,0);

citys[286]=new Array('ls','丽水','lishui','lishui','547','zhejiang','浙江','','',285,0);

citys[287]=new Array('wfd','瓦房店','wafangdian','wafangdian','7','liaoning','辽宁','','',366,0);

citys[288]=new Array('sy','沭阳','shuyang','shuyang','6','jiangsu','江苏','','',363,0);

citys[289]=new Array('wys','武夷山','wuyishan','wuyishan','337','fujian','福建','','',349,0);

citys[290]=new Array('bz','亳州','bozhou','bozhou','21','anhui','安徽','','',314,0);

citys[291]=new Array('bs','百色','baise','baise','22','guangxi','广西','','',139,0);

citys[292]=new Array('hz','贺州','hezhou','hezhou','84','guangxi','广西','','',319,0);

citys[293]=new Array('wlcb','乌兰察布','wulanchabu','wulanchabu','33','neimenggu','内蒙古','','',153,0);

citys[294]=new Array('zw','中卫','zhongwei','zhongwei','90','ningxia','宁夏','','',342,0);

citys[295]=new Array('jc','金昌','jinchang','jinchang','6','gansu','甘肃','','',167,0);

citys[296]=new Array('by','白银','baiyin','baiyin','1','gansu','甘肃','','',168,0);

citys[297]=new Array('pl','平凉','pingliang','pingliang','11','gansu','甘肃','','',172,0);

citys[298]=new Array('dx','定西','dingxi','dingxi','2','gansu','甘肃','','',175,0);

citys[299]=new Array('tc','铜川','tongchuan','tongchuan','5','shanxi','陕西','','',177,0);

citys[300]=new Array('yt','鹰潭','yingtan','yingtan','5','jiangxi','江西','','',219,0);

citys[301]=new Array('zt','昭通','zhaotong','zhaotong','36','yunnan','云南','','',229,0);

citys[302]=new Array('bygl','巴音郭楞','bayinguoleng','bayinguoleng','18','xinjiang','新疆','','',249,0);

citys[303]=new Array('lz','林芝','linzhi','linzhi','99','xicang','西藏','','',262,0);

citys[304]=new Array('tr','铜仁','tongren','tongren','54','guizhou','贵州','','',40,0);

citys[305]=new Array('lb','来宾','laibin','laibin','4','guangxi','广西','','',141,0);

citys[306]=new Array('cz','崇左','chongzuo','chongzuo','17','guangxi','广西','','',320,0);

citys[307]=new Array('xz','忻州','xinzhou','xinzhou','36','shanxi','山西','','',163,0);
...
citys[313]=new Array('yx','玉溪','yuxi','yuxi','243','yunnan','云南','','',227,0);

citys[314]=new Array('hh','红河','honghe','honghe','194','yunnan','云南','','',234,0);

citys[315]=new Array('dh','德宏','dehong','dehong','22','yunnan','云南','','',238,0);

citys[316]=new Array('tlf','吐鲁番','tulufan','tulufan','14','xinjiang','新疆','','',243,0);

citys[317]=new Array('qn','黔南','qiannan','qiannan','217','guizhou','贵州','','',44,0);

citys[318]=new Array('df','大丰','dafeng','dafeng','1','jiangsu','江苏','','',364,0);

citys[319]=new Array('zd','正定','zhengding','zhengding','1','hebei','河北','','',357,0);

citys[320]=new Array('zb','张北','zhangbei','zhangbei','3','hebei','河北','','',358,0);

citys[321]=new Array('hb','鹤壁','hebi','hebi','7','henan','河南','','',107,0);

citys[322]=new Array('tc','桐城','tongcheng','tongcheng','2','anhui','安徽','','',346,0);

citys[323]=new Array('wzs','五指山','wuzhishan','wuzhishan','6','hainan','海南','','',353,0);

citys[324]=new Array('xa','兴安','xingan','xingan','114','neimenggu','内蒙古','','',154,0);

citys[325]=new Array('jyg','嘉峪关','jiayuguan','jiayuguan','121','gansu','甘肃','','',343,0);

citys[326]=new Array('lx','临夏','linxia','linxia','5','gansu','甘肃','','',325,0);

citys[327]=new Array('sl','商洛','shangluo','shangluo','7','shanxi','陕西','','',185,0);

citys[328]=new Array('hd','海东','haidong','haidong','41','qinghai','青海','','',187,0);

citys[329]=new Array('hb','海北','haibei','haibei','109','qinghai','青海','','',188,0);

citys[330]=new Array('gl','果洛','guoluo','guoluo','1','qinghai','青海','','',191,0);

citys[331]=new Array('xt','仙桃','xiantao','xiantao','1','hubei','湖北','','',202,0);

citys[332]=new Array('sz','随州','suizhou','suizhou','2','hubei','湖北','','',330,0);

citys[333]=new Array('bs','保山','baoshan','baoshan','213','yunnan','云南','','',228,0);

citys[334]=new Array('cx','楚雄','chuxiong','chuxiong','19','yunnan','云南','','',236,0);

citys[335]=new Array('pe','普洱','puer','puer','63','yunnan','云南','','',231,0);

citys[336]=new Array('lc','临沧','lincang','lincang','3','yunnan','云南','','',232,0);

citys[337]=new Array('ws','文山','wenshan','wenshan','75','yunnan','云南','','',233,0);

citys[338]=new Array('nj','怒江','nujiang','nujiang','1','yunnan','云南','','',239,0);

citys[339]=new Array('dq','迪庆','diqing','diqing','132','yunnan','云南','','',240,0);

citys[340]=new Array('ht','和田','hetian','hetian','1','xinjiang','新疆','','',245,0);

citys[341]=new Array('wc','文昌','wenchang','wc','227','hainan','海南','','',397,0);

citys[342]=new Array('qh','琼海','qionghai','qionghai','286','hainan','海南','','',399,0);

citys[343]=new Array('dz','儋州','danzhou','danzhou','107','hainan','海南','','',400,0);

citys[344]=new Array('wn','万宁','wanning','wanning','212','hainan','海南','','',401,0);

citys[345]=new Array('df','东方','dongfang','dongfang','35','hainan','海南','','',402,0);

citys[346]=new Array('da','定安','dingan','dingan','2','hainan','海南','','',403,0);

citys[347]=new Array('tc','屯昌','tunchang','tunchang','4','hainan','海南','','',404,0);

citys[348]=new Array('cm','澄迈','chengmai','chengmai','151','hainan','海南','','',405,0);

citys[349]=new Array('lg','临高','lingao','lingao','18','hainan','海南','','',406,0);

citys[350]=new Array('bs','白沙','baisha','baisha','2','hainan','海南','','',407,0);

citys[351]=new Array('cj','昌江','changjiang','changjiang','27','hainan','海南','','',408,0);

citys[352]=new Array('ld','乐东','ledong','ledong','35','hainan','海南','','',409,0);

citys[353]=new Array('ls','陵水','lingshui','lingshui','347','hainan','海南','','',410,0);

citys[354]=new Array('bt','保亭','baoting','baoting','21','hainan','海南','','',411,0);

citys[355]=new Array('qz','琼中','qiongzhong','qiongzhong','5','hainan','海南','','',412,0);

citys[356]=new Array('ylx','宜兰县','yilanxian','ylxian','1','taiwan','台湾','','',393,0);

citys[357]=new Array('changbaish','长白山','changbaishan','changbaishan','260','jilin','吉林','','',413,0);

citys[358]=new Array('tb','台北','taibei','taipei','1092','taiwan','台湾','','',378,0);

citys[359]=new Array('xb','新北','xinbei','newnorth','15','taiwan','台湾','','',379,0);

citys[360]=new Array('tz','台中','taizhong','taichung','470','taiwan','台湾','','',380,0);

citys[361]=new Array('tn','台南','tainan','tainan','559','taiwan','台湾','','',381,0);

citys[362]=new Array('gx','高雄','gaoxiong','kaohsiung','519','taiwan','台湾','','',382,0);

citys[363]=new Array('xz','新竹','xinzhu','hsinchu','1','taiwan','台湾','','',384,0);

citys[364]=new Array('jy','嘉义','jiayi','chiayi','308','taiwan','台湾','','',385,0);

citys[365]=new Array('tys','桃园市','taoyuanshi','taoyuan','1','taiwan','台湾','','',386,0);

citys[366]=new Array('ntx','南投县','nantouxian','ntx','666','taiwan','台湾','','',390,0);

citys[367]=new Array('jyx','嘉义县','jiayixian','jyx','3','taiwan','台湾','','',392,0);

citys[368]=new Array('hlx','花莲县','hualianxian','hlx','1265','taiwan','台湾','','',394,0);

citys[369]=new Array('tdx','台东县','taidongxian','tdx','1','taiwan','台湾','','',395,0);

citys[370]=new Array('phx','澎湖县','penghuxian','phx','3','taiwan','台湾','','',396,0);

citys[371]=new Array('pdx','屏东县','pingdongxian','pingtungcounty','1066','taiwan','台湾','','',2764,0);
...
abroadcitys[2]=new Array('dld','多伦多','duolunduo','toronto','35','','安大略省','','',712,1,'-06:00');
...
abroadcitys[9]=new Array('ml','米兰','milan','milan','14','','伦巴第','','',1150,1,'+01:00');

abroadcitys[10]=new Array('wns','威尼斯','weinisi','venice','3','','威尼托','','',1155,1,'+01:00');

abroadcitys[11]=new Array('flls','佛罗伦萨','foluolunsa','florence','12','','托斯卡纳','','',1174,1,'+01:00');

abroadcitys[12]=new Array('lm','罗马','luoma','rome','40','','拉齐奥','','',1181,1,'+01:00');

abroadcitys[13]=new Array('mgw','名古屋','nagoya','nagoya','856','','爱知县','','',1193,1,'+09:00');

abroadcitys[14]=new Array('zh','札幌','sapporo','sapporo','1115','','北海道','','',1194,1,'+09:00');

abroadcitys[15]=new Array('fg','福冈','fugang','fukuoka','41','','福冈县','','',1197,1,'+09:00');

abroadcitys[16]=new Array('cs','冲绳','chongsheng','okinawa','976','','冲绳','','',1218,1,'+09:00');

abroadcitys[17]=new Array('msk','莫斯科','mosike','moscow','37','','中央','','',1897,1,'+03:00');

abroadcitys[18]=new Array('sbdb','圣彼得堡','shengbidebao','saintpetersburg','16','','西北','','',1914,1,'+03:00');

abroadcitys[19]=new Array('bsln','巴塞罗那','basailuona','barcelona','48','','巴塞罗那','','',2049,1,'+01:00');
...
abroadcitys[22]=new Array('ld','伦敦','lundun','london','33','','英格兰','','',2242,1,'+00:00');

abroadcitys[23]=new Array('jjs','旧金山','jiujinshan','sanfrancisco','9','','加利福尼亚','','',2360,1,'-08:00');

abroadcitys[24]=new Array('bsd','波士顿','boshidun','boston','7','','马萨诸塞','','',2406,1,'-05:00');

abroadcitys[25]=new Array('lswjs','拉斯维加斯','lasiweijiasi','lasvegas','17','','内华达','','',2460,1,'-07:00');

abroadcitys[26]=new Array('ny','纽约','niuyue','newyork','40','','纽约','','',2465,1,'-05:00');
...
abroadcitys[30]=new Array('kes','凯恩斯','kaiensi','keynes','8','','昆士兰','','',533,1,'+10:00');
...
abroadcitys[58]=new Array('yjd','雅加达','yajiada','jakarta','432','','大雅加达首都特区','','',1124,1,'+07:00');

abroadcitys[59]=new Array('wl','万隆','wanlong','bandung','81','','西爪哇省','','',1126,1,'+07:00');

abroadcitys[60]=new Array('ss','泗水','sishui','shuishui','29','','东爪哇省','','',1127,1,'+07:00');

abroadcitys[61]=new Array('rr','日惹','rire','yogyas','70','','日惹特区','','',1128,1,'+07:00');
...
abroadcitys[66]=new Array('sh','神戸','shenhu','kobe','763','','兵库县','','',1195,1,'+09:00');

abroadcitys[67]=new Array('cq','川崎','chuanqi','kawasaki','1','','神奈川县','','',1198,1,'+09:00');

abroadcitys[68]=new Array('qy','埼玉','qiyu','saitama','3','','埼玉县','','',1199,1,'+09:00');
...
abroadcitys[72]=new Array('nl','奈良','nara','nara','230','','奈良县','','',1217,1,'+09:00');

abroadcitys[73]=new Array('jb','金边','jinbian','phnompenh','15','','金边市','','',1232,1,'+07:00');
...
abroadcitys[78]=new Array('rc','仁川','renchuan','incheon','474','','仁川','','',1293,1,'+09:00');
...
abroadcitys[81]=new Array('qz','庆州','qingzhou','gyeongju','168','','庆尚北道','','',1328,1,'+09:00');
...
abroadcitys[86]=new Array('bc','槟城','bincheng','penang','181','','槟榔屿','','',1496,1,'+08:00');

abroadcitys[87]=new Array('fljy','浮罗交怡','fuluojiaoyi','langkawi','2','','吉打','','',1509,1,'+08:00');

abroadcitys[88]=new Array('mlj','马六甲','maliujia','malacca','192','','马六甲','','',1527,1,'+08:00');

abroadcitys[89]=new Array('ylyy','亚罗牙也','yaluoyaye','arroyoalso','1','','马六甲','','',1528,1,'+08:00');

abroadcitys[90]=new Array('yb','怡保','yibao','ipoh','58','','霹雳','','',1550,1,'+08:00');

abroadcitys[91]=new Array('xs','新山','xinshan','johor','157','','柔佛','','',1558,1,'+08:00');

abroadcitys[92]=new Array('dyl','斗亚兰','eryalan','doolan','1','','沙巴','','',1574,1,'+08:00');

abroadcitys[93]=new Array('xbn','仙本那','xianbenna','sakamoto','18','','沙巴','','',1588,1,'+08:00');
...
abroadcitys[96]=new Array('xb','雪邦','xuebang','spontan','2','','雪兰莪','','',1607,1,'+08:00');

abroadcitys[97]=new Array('fld','费利杜','feilidu','felicu','2','','费利杜','','',1616,1,'+05:00');

abroadcitys[98]=new Array('mxgc','墨西哥城','moxigecheng','mexico','1','','联邦区','','',1646,1,'-06:00');

abroadcitys[99]=new Array('mlks','马拉喀什','malakashi','marrakech','1','','马拉喀什','','',1699,1,'+00:00');

abroadcitys[100]=new Array('wdhk','温得和克','wendeheke','windhoek','1','','霍马斯','','',1702,1,'+01:00');

abroadcitys[101]=new Array('jdmd','加德满都','jiademaner','kathmandu','8','','加德满都','','',1711,1,'+05:45');

abroadcitys[102]=new Array('amstd','阿姆斯特丹','amusitedan','amsterdam','2','','北荷兰','','',1728,1,'+01:00');

abroadcitys[103]=new Array('hmed','哈密尔顿','hamierdun','hamilton','2','','怀卡托','','',1744,1,'+12:00');

abroadcitys[104]=new Array('bpmsd','北帕默斯顿','beipmsd','beipmsd','1','','玛纳瓦图/旺格努伊','','',1748,1,'+12:00');

abroadcitys[105]=new Array('dgs','迪戈斯','digesi','digos','122','dawoqu','达沃区','','',1798,1,'+08:00');

abroadcitys[106]=new Array('lsb','里斯本','lisiben','lisbon','3','','大里斯本','','',1871,1,'+00:00');

abroadcitys[107]=new Array('yekck','伊尔库茨克','yierkucike','irkutsk','1','','西伯利亚','','',1957,1,'+08:00');

abroadcitys[108]=new Array('hcw','海参崴','haicanwei','vladivostok','1','','远东','','',1968,1,'+09:00');

abroadcitys[109]=new Array('pem','帕尔马','paem','paem','2','','巴利阿里群岛','','',2030,1,'+01:00');

abroadcitys[110]=new Array('hln','赫罗纳','heluona','girona','1','','赫罗纳','','',2050,1,'+01:00');

abroadcitys[111]=new Array('klp','科伦坡','kelunpo','colombo','11','','科伦坡县','','',2069,1,'+05:30');

abroadcitys[112]=new Array('ngb','尼甘布','niganbu','negambo','3','','加姆珀哈县','','',2075,1,'+05:30');

abroadcitys[113]=new Array('kt','康提','kangti','kandy','19','','康提县','','',2076,1,'+05:30');

abroadcitys[114]=new Array('sdgem','斯德哥尔摩','sidegeermo','stockholm','1','','斯德哥尔摩省','','',2117,1,'+01:00');

abroadcitys[115]=new Array('sls','苏黎世','sulishi','zurich','2','','苏黎世','','',2124,1,'+01:00');

abroadcitys[116]=new Array('ben','伯尔尼','boerni','berni','1','','伯尔尼','','',2125,1,'+01:00');

abroadcitys[117]=new Array('rnw','日内瓦','rineiwa','geneva','1','','日内瓦','','',2129,1,'+01:00');

abroadcitys[118]=new Array('akl','安卡拉','ankala','ankara','1','','安卡拉','','',2186,1,'+02:00');

abroadcitys[119]=new Array('db','迪拜','dibai','dubai','3','','迪拜酋长国','','',2203,1,'+04:00');

abroadcitys[120]=new Array('bmh','伯明翰','bominghan','birmingham','1','','英格兰','','',2222,1,'+00:00');

abroadcitys[121]=new Array('lst','列斯特','liesite','lester','1','','英格兰','','',2240,1,'+00:00');

abroadcitys[122]=new Array('mcst','曼彻斯特','manchesite','manchester','1','','英格兰','','',2243,1,'+00:00');

abroadcitys[123]=new Array('sdl','桑德兰','sangdelan','sunderland','1','','英格兰','','',2254,1,'+00:00');

abroadcitys[124]=new Array('dls','达拉斯','dalasi','dallas','1','','德克萨斯','','',2308,1,'-06:00');

abroadcitys[125]=new Array('klfl','克利夫兰','kelifulan','cleveland','1','','俄亥俄','','',2317,1,'-05:00');

abroadcitys[126]=new Array('ald','奥兰多','aolanduo','orlando','11','','佛罗里达','','',2338,1,'-05:00');

abroadcitys[127]=new Array('mam','迈阿密','maiami','miami','3','','佛罗里达','','',2343,1,'-05:00');

abroadcitys[128]=new Array('sdg','圣迭戈','shengdiege','sandiego','1','','加利福尼亚','','',2362,1,'-08:00');

abroadcitys[129]=new Array('shs','圣何塞','shenghs','shenghs','9','','加利福尼亚','','',2363,1,'-08:00');

abroadcitys[130]=new Array('xael','新奥尔良','xinaoerliang','neworleans','1','','路易斯安那','','',2395,1,'-06:00');

abroadcitys[131]=new Array('txs','檀香山','tanxiangshan','honolulu','7','','夏威夷','','',2498,1,'-10:00');

abroadcitys[132]=new Array('ytld','亚特兰大','yatelanda','atlanta','1','','佐治亚','','',2550,1,'-05:00');

abroadcitys[133]=new Array('hn','河内','henei','hanoi','145','','河内市','','',2582,1,'+07:00');

abroadcitys[134]=new Array('hzm','胡志明','huzhiming','hochiminh','520','','胡志明市','','',2583,1,'+07:00');

abroadcitys[135]=new Array('dbls','第比利斯','dibilisi','tbilisi','7','','第比利斯','','',2603,1,'+04:00');

abroadcitys[136]=new Array('dke','达喀尔','dakaer','dakar','1','','达喀尔','','',2613,1,'+00:00');

abroadcitys[137]=new Array('kpd','开普敦','kaipudun','capetown','1','','开普敦','','',2616,1,'+02:00');

abroadcitys[138]=new Array('mataram','马塔兰','mataram','mataram','2','nusaenggarabarat','西努沙登加拉','','',2714,1,'+08:00');

abroadcitys[139]=new Array('saipan','塞班岛','saipan','saipan','21','northernmariana','北马里亚纳','','',2716,1,'+10:00');

abroadcitys[140]=new Array('pasai','帕赛','pasai','pasay','6','maniladaduhui','马尼拉大都会','','',2719,1,'+08:00');

abroadcitys[141]=new Array('maynila','马尼拉','maynila','maynila','2','maniladaduhui','马尼拉大都会','','',2720,1,'+08:00');

abroadcitys[142]=new Array('makadi','马卡蒂','makadi','makati','2','maniladaduhui','马尼拉大都会','','',2723,1,'+08:00');

abroadcitys[143]=new Array('paxige','帕西格','paxige','pasig','2','maniladaduhui','马尼拉大都会','','',2730,1,'+08:00');

abroadcitys[144]=new Array('tajige','塔吉格','tajige','tajig','1','maniladaduhui','马尼拉大都会','','',2733,1,'+08:00');

abroadcitys[145]=new Array('bashu','巴蜀','bashu','bayu','1','prachuap','班武里府','','',2735,1,'+7:00');

abroadcitys[146]=new Array('huaxin','华欣','huaxin','huaxin','1073','prachuap','班武里府','','',2741,1,'+7:00');

abroadcitys[147]=new Array('beilan','北榄','beilan','northernlam','3','beilan','北榄','','',2744,1,'+7:00');

abroadcitys[148]=new Array('baixian','拜县','baixian','paicounty','150','yefengsong','夜丰颂','','',2745,1,'+7:00');

abroadcitys[149]=new Array('jiami','甲米','jiami','krabi','886','jiami','甲米','','',2746,1,'+7:00');

abroadcitys[150]=new Array('naba','那霸','naba','naha','21','','冲绳','','',2749,1,'+09:00');

abroadcitys[151]=new Array('putianshi','浦添','putianshi','putianshi','1','','冲绳','','',2752,1,'+09:00');

abroadcitys[152]=new Array('yuliuma','宇流麻','yuliuma','uruma','2','','冲绳','','',2756,1,'+09:00');

abroadcitys[153]=new Array('guotou','国头','guotou','guotou','1','','冲绳','','',2759,1,'+09:00');

abroadcitys[154]=new Array('boracay','长滩岛','boracay','boracay','11','ximishayan','西米沙鄢','','',2851,1,'+08:00');

abroadcitys[155]=new Array('atami','热海','atami','atami','1','','静冈县','','',2853,1,'+09:00');

abroadcitys[156]=new Array('coquitlam','高贵林','coquitlam','coquitlam','4','','不列颠哥伦比亚省','','',2743,1,'-08:00');

abroadcitys[157]=new Array('xiaozun','小樽','xiaozun','small','193','','北海道','','',2765,1,'+9:00');

abroadcitys[158]=new Array('jiangbie','江别','jiangbie','jiangbie','1','','北海道','','',2777,1,'+9:00');

abroadcitys[159]=new Array('kaerjiali','卡尔加里','kaerjiali','calgary','1','','艾伯塔省','','',2798,1,'-7:00');

abroadcitys[160]=new Array('vancouver','温哥华','vancouver','vancouver','6','','不列颠哥伦比亚省','','',2801,1,'-8:00');

abroadcitys[161]=new Array('westvancou','西温','westvancouver','westwen','2','','不列颠哥伦比亚省','','',2802,1,'-8:00');

abroadcitys[162]=new Array('richmond','列治文','richmond','richmondcan','25','','不列颠哥伦比亚省','','',2803,1,'-8:00');

abroadcitys[163]=new Array('burnaby','本那比','burnaby','benabi','10','','不列颠哥伦比亚省','','',2804,1,'-8:00');

abroadcitys[164]=new Array('surrey','素里','surrey','suri','4','','不列颠哥伦比亚省','','',2805,1,'-8:00');

abroadcitys[165]=new Array('newwestmin','新威斯敏斯特','newwestminster','newwestminster','1','','不列颠哥伦比亚省','','',2808,1,'-8:00');

abroadcitys[166]=new Array('shanzhongh','山中湖','shanzhonghu','yamanakako','1','shanli','山梨','','',2831,1,'+09:00');

abroadcitys[167]=new Array('fushihekou','富士河口湖','fushihekouhu','fujikawaguchiko','6','shanli','山梨','','',2833,1,'+09:00');

abroadcitys[168]=new Array('queenstown','皇后镇','queenstown','queenstown','1','','奥塔戈','','',2848,1,'+12:00');

abroadcitys[169]=new Array('mtle','蒙特利尔','mengtelier','montreal','2','','魁北克省','','',2855,1,'-04:00');

abroadcitys[170]=new Array('wotaihua','渥太华','wth','ottawa','3','','安大略省','','',2856,1,'-06:00');

abroadcitys[171]=new Array('nyjlpbc','尼亚加拉瀑布城','niyajialapubucheng','niagarafalls','2','','安大略省','','',2857,1,'-06:00');

abroadcitys[172]=new Array('lkw','兰卡威','lankawei','pulaulangkawi','1','','吉打','','',2858,1,'+08:00');

abroadcitys[173]=new Array('be','波恩','boen','bonn','1','','北莱茵-威斯特法伦','','',2860,1,'+01:00');

abroadcitys[174]=new Array('bkl','博卡拉','bokala','pokhara','7','gandaji','甘达基区','','',2879,1,'+05:45');

abroadcitys[175]=new Array('bhd','薄荷岛','bohedao','boholisland','3','zhongmishayan','中米沙鄢','','',2882,1,'+08:00');

abroadcitys[176]=new Array('lc','镰仓','liancang','kamakura','3','','神奈川县','','',2896,1,'+9:00');

abroadcitys[177]=new Array('luotuoluwa','罗托鲁瓦','luotuoluwashi','rotorua','1','','普伦蒂湾','','',2899,1,'+12:00');
