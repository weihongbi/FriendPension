...
var DEBUG = false;
var xiaozhuWebimCSS = 'webimV4.css'/*tpa=https://jci.xiaozhustatic1.com/e19061701/webimV4.css*/;
...
function uploadifyFeedBackInit() {
    ...
    $('#feedback_file_upload').uploadify({
            ...
            'width': 50,
            'height': 20,
            'swf'      : 'uploadify.swf'/*tpa=https://jci.xiaozhustatic1.com/swf/uploadify.swf*/,
...
function AjaxGetFeedBack() {
 ...
 $(window).load(function() {
    ...
    {
        $.getScript("jquery.nyroModal.custom.min.js"/*tpa=https://jci.xiaozhustatic1.com/js/jquery/jquery-plugin/jquery.nyroModal.custom.min.js*/);
        $.getScript("jquery.nyroModal-ie6.min.js"/*tpa=https://jci.xiaozhustatic1.com/js/jquery/jquery-plugin/jquery.nyroModal-ie6.min.js*/,loadNyroModal);
    }else{
        $.getScript("jquery.nyroModal.custom.min.js"/*tpa=https://jci.xiaozhustatic1.com/js/jquery/jquery-plugin/jquery.nyroModal.custom.min.js*/,loadNyroModal);
    }
    }catch(e){}
});
                ...
                if(returndata.status == 0) {
                    ...
                    if(returndata.next){
                        if(returndata.backnext == 1){
                            var hint = $("#hint").val();
                            if(hint){
                                window.location.href = "https://jci.xiaozhustatic1.com/";
                            }else{
                                location.reload();
                            }
                        }else{
...
goog.TRANSPILER = "transpile.js"/*tpa=https://jci.xiaozhustatic1.com/e19061701/transpile.js*/;
    ...
    if (goog.isDef(goog.global.CLOSURE_BASE_PATH)) {
        ...
        if (goog.inHtmlDocument_()) {
            for (var a = goog.global.document.getElementsByTagName("SCRIPT"), b = a.length - 1;0 <= b;--b) {
                ...
                if ("base.js"/*tpa=https://jci.xiaozhustatic1.com/e19061701/base.js*/ == c.substr(d - 7, 7)) {
...
/*asyoutypeformatter.js*/ 
 $(window).load(function() {
    !function(e,t,n,g,i){e[i]=e[i]||function(){(e[i].q=e[i].q||[]).push(arguments)},n=t.createElement("script"),tag=t.getElementsByTagName("script")[0],n.async=1,n.src=('https:'==document.location.protocol?'https://':'http://')+g,tag.parentNode.insertBefore(n,tag)}(window,document,"script","gio.js"/*tpa=https://jci.xiaozhustatic1.com/e19061701/assets.growingio.com/2.1/gio.js*/,"gio");
    ...
    function updatePS(pageGroup, pushObj){
        gio('https://jci.xiaozhustatic1.com/e19061701/page.set','pageGroup', pageGroup);
        for (var k in pushObj ) {
            gio('https://jci.xiaozhustatic1.com/e19061701/page.set',k,pushObj[k]);
        }
        try {
            gio('sendPage');
        } catch (e) {} finally {}
    ...
    (function(w,d,s,l,a){
        ...
        c.src='a.js'/*tpa=https://fm.ipinyou.com/j/a.js*/;
...
(function () {
    ...
    function domainConfig(domain) {
        var url = new Array();
        url['https://jci.xiaozhustatic1.com/e19061701/www.baidu.com'] = {'ca_source' : 'pcbaiduseo', 'utm_source' : 'baidu', 'key' : ''};
        url['https://jci.xiaozhustatic1.com/e19061701/m.baidu.com'] = {'ca_source' : 'h5baiduseo', 'utm_source' : 'baidu', 'key' : '&title='};
        url['https://jci.xiaozhustatic1.com/e19061701/www.sogou.com'] = {'ca_source' : 'pcsogouseo', 'utm_source' : 'sogou', 'key' : '&query='};
        url['https://jci.xiaozhustatic1.com/e19061701/m.sogou.com'] = {'ca_source' : 'h5sogouseo', 'utm_source' : 'sogou', 'key' : '&keyword='};
        url['https://jci.xiaozhustatic1.com/e19061701/www.so.com'] = {'ca_source' : 'pc360seo', 'utm_source' : '360', 'key' : '?q='};
        url['https://jci.xiaozhustatic1.com/e19061701/m.so.com'] = {'ca_source' : 'h5360seo', 'utm_source' : '360', 'key' : '?q='};
               ...
               if(datas.status==1){
                  ...
                  if(datas.sucmsg.isShow==true){
                     ...
                     var wrapperHtml = '<div class="dialogRoom">'+
                        ...
                        '</div>'+
                        '<div class="xzRemaind">'+
                        '<img src="diaBg.png"/*tpa=https://jci.xiaozhustatic1.com/images/diaBg.png*/>';
                     //文案部分拼接；
...
function loadShadePageStyle() {
    ...
    link.type='text/css';
    link.rel = 'stylesheet';
    link.href = 'shadepage.css'/*tpa=https://jci.xiaozhustatic1.com/css/shadepage.css*/;
